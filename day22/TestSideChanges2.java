...
public class TestSideChanges2 {

	public static void main(String[] args) throws Exception {
		TestSideChanges2 obj = new TestSideChanges2();
	}
	...
	@Before
		public void setUp() throws Exception {
			...
			ArrayList<String> data = dataObj.getData("layout.txt");

			CubeFactory cubeFactory = new CubeFactory();
			Cube cube = cubeFactory.buildCube(data);
			assertEquals(200, cube.layout.size());

			instructions.cube = cube;
			maxIndex = instructions.cube.getCurrentSide().sideLength - 1;
	...
	@Test public void Test01to06() throws Exception{
		...
		setPositionAndVerify(1, 2, maxIndex, "R");
		instructions.instructions = "1";

		logger.log("Start " + testName);
		instructions.run();		
		testPosition(6,2,0, "R");
	...
	@Test public void Test01to04() throws Exception{
		...
		logger.log("Prepare " + testName);
		setPositionAndVerify(1, maxIndex, 1, "D");
		instructions.instructions = "1";
	...
	@Test public void Test02to05() throws Exception{
		...
		helper.setStartPosition(2, 2, maxIndex, "R");

		helper.run(5,maxIndex,2, "U");		
	}
	...
	@Test public void Test02to06() throws Exception{
		...
		helper.setStartPosition(2, maxIndex, 3, "D");
	...
	@Test public void Test02to01() throws Exception{
		...
		helper.setStartPosition(2, 10, 0, "L");
	...
	@Test public void Test03to04() throws Exception{
		...
		// Starting from the default col/row hits a wall. Use different ones.
		setPosition(1, 1);

		helper.setStartPosition(3, 0, 1, "U");
	...
	@Test public void Test03to05() throws Exception{
		...
		helper.setStartPosition(3, 2, maxIndex, "R");
	...
	@Test public void Test03to02() throws Exception{
		...
		helper.setStartPosition(3, maxIndex, 10, "D");
	...
	@Test public void Test03to01() throws Exception{
		...
		helper.setStartPosition(3, 3, 0, "L");

		helper.run(1,maxIndex-3,0, "R");		
	}
	...
	@Test public void Test04to06() throws Exception{
		...
		helper.setStartPosition(4, 0, maxIndex, "R");

		helper.run(6,maxIndex, 0, "U");		
	}
	...
	@Test public void Test04to05() throws Exception{
		...
		helper.setStartPosition(4, maxIndex, 1, "D");
	...
	@Test public void Test05to06() throws Exception{
		...
		helper.setStartPosition(5, 1, maxIndex, "R");

		helper.run(6,maxIndex-1,maxIndex, "L");		
	}
	...
	@Test public void Test05to02() throws Exception{
		...
		helper.setStartPosition(5, maxIndex, 2, "D");

		helper.run(2,2,maxIndex, "L");		
	}
	...
	@Test public void Test05to04() throws Exception{
		...
		helper.setStartPosition(5,0,2,"U");

		helper.run(4,maxIndex, 2, "U");		
	}
	...
	@Test public void Test06to01() throws Exception{
		...
		helper.setStartPosition(6, 1, 0, "L");

		helper.run(1,1,maxIndex, "L");		
	}
	...
	@Test public void Test06to05() throws Exception{
		...
		helper.setStartPosition(6, 2, maxIndex, "R");

		helper.run(5,maxIndex-2,maxIndex, "L");		
	}
	...
	@Test public void Test06to04() throws Exception{
		...
		helper.setStartPosition(6, maxIndex, 1, "D");

		helper.run(4,1,maxIndex, "L");		
	}
